...
//扩展1:添加更多顶点到数据中，使用glDrawArrays，尝试绘制两个彼此相连的三角形
#include <iostream>
#include <glad/glad.h>
...
int main(){
...
#endif
    //接着创建窗口
    GLFWwindow *window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "2.画两个相连的三角形", NULL, NULL);
    if(window == NULL){
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        glBindVertexArray(VAO);
        glDrawArrays(GL_TRIANGLES,0,6);//绘制三角形，六个顶点
